...
- [`08033ffe4`](https://github.com/dashpay/dash/commit/08033ffe4) Reject Polis-specific messages from obsolete peers (#1983)
...
- [`532b9fa3d`](https://github.com/dashpay/dash/commit/532b9fa3d) Use OpenNetworkConnection instead of calling ConnectNode directly in Polis code (#1857)
...
- [`4ea790377`](https://github.com/dashpay/dash/commit/4ea790377) Polisify lib names (#2035)
...
- [`c65613350`](https://github.com/dashpay/dash/commit/c65613350) Switch masternode id in Polis data structures from CTxIn to COutPoint (#1933)
...
- [`a7fa07a30`](https://github.com/dashpay/dash/commit/a7fa07a30) Drop BOOST_FOREACH and use references in loops (const ref where applicable, Polis code only) (#1899)
