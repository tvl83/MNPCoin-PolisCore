...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_15_FULL_POS_V3,                   4070908800ULL}, // OFF
...
int CSporkManager::GetSporkIDByName(const std::string& strName)
{
    ...
    if (strName == "SPORK_15_FULL_POS_V3")                      return SPORK_15_FULL_POS_V3;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        case SPORK_15_FULL_POS_V3:                      return "SPORK_15_FULL_POS_V3";
