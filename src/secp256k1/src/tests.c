...
void test_rand_bits(int rand32, int bits) {
    ...
    static const uint32_t mults[6] = {1, 3, 21, 289, 0x11111, 0x80402011};
...
void run_rand_int(void) {
    static const uint32_t ms[] = {1, 3, 17, 1000, 13771, 1111199, 33554432};
...
void run_ecmult_chain(void) {
    ...
    for (i = 0; i < 200*count; i++) {
        ...
        /* verify */
        if (i == 111111) {
            /* expected result after 111111 iterations */
