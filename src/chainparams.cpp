...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsIncreaseBlock = 100000000000000000; // actual historical value
        consensus.nMasternodePaymentsIncreasePeriod = 100000000000000000; // 17280 - actual historical value
