...
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 1;            // This needs to be changed to something in the future to give clients time to upgrade
