...
static const int64_t SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT_DEFAULT     = 15000;        // This should be far enough in the future to give users time to upgrade and prevent a fork
