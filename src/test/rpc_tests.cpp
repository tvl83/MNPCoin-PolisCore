...
BOOST_AUTO_TEST_CASE(rpc_format_monetary_values)
{
    ...
    BOOST_CHECK(ValueFromAmount(2011111111111111190LL).write() == "201111199.111119990");
    BOOST_CHECK(ValueFromAmount(2011111111111111199LL).write() == "201111199.1111111111");
...
BOOST_AUTO_TEST_CASE(rpc_parse_monetary_values)
{
    ...
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("201111199.11111999")), 2011111111111111190LL);
    BOOST_CHECK_EQUAL(AmountFromValue(ValueFromString("201111199.1111111111")), 2011111111111111199LL);
